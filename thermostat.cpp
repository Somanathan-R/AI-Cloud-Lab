...
using namespace std;
int environmentSensor(double *envTemp, double *humidity) {
    *envTemp = 45.0;
    *humidity = 60.0;
    return 0;
}

int bodySensor(double *bodyTemp) {
    *bodyTemp = 37.0;
    return 0;
}

void HomeThermostat(double envTemperature, double humidity, double bodyTemperature) {
    if ((envTemperature > bodyTemperature) || (envTemperature < bodyTemperature - 10) && (humidity < 61 || humidity > 61)) {
